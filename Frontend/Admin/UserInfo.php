              ...
              <?php
                      ...
                      while($row = mysqli_fetch_row($kq))
                      {
                        ...
                        <tr key=$row[0] id='item'>
                            ...
                            <td>$row[1]</td>
                            <td>
                            <a href='updateUser.php?edit=$row[0]'><button class='my-2 btn btn-info' >Edit</button></a>      
                              <a href='processUser.php?delete=$row[0]'><button class='my-2 btn btn-danger' onclick='xoa($row[2])' )'>Delete</button></a>
                            </td>
                        </tr>
                        ";
                      };
