				...
				<div class="collection_section_2">
					<div class="row">
						<div class = "login_box" style ="margin-left: 120px">
							<input class="center-block" type="text" id="account" name="email" placeholder = "Enter Account" style="width: 400px;"><br><br>
							<input class="center-block" type="password" id="pass" name="matkhau" placeholder = "Enter Password" style="width: 400px;">
							<p> Don't have an account?<a href="Registration.html"> Click here</a></p><br>
