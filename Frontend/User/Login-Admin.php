                        ...
                        <div class="row">
                            <div class="login_box" style="margin-left: 120px">
                                <div id="message" style="text-align: center;; color: red;"></div>
                                    <input class="center-block" type="email" id="email" name="Email" placeholder="Enter Email" required style="width: 400px;"><br><br>
                                    <input class="center-block" type="password" id="pass" name="MatKhau" placeholder="Enter Password" required style="width: 400px;"><br>
