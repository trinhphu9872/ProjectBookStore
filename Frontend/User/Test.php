                        ...
                        while($row = mysqli_fetch_row($kq)) {
                            ...
                            <div class='col-7 mx-auto '>
                                ...
                                <h4> <i class='fa fa-store'></i> Tồn kho : $row[7]</h4>
                                    ...
                                    <h4> <label for='count'><i class='fa fa-shopping-basket'></i>  Số lượng</label>    <input  type='number' class='form-control mt-2' id='count' min='0' max='$row[7]' id='quanlity' required></h4>
     ...
     ?>
                ...
                <script>
                        function addItemCart(item){
                            var idItem = $(item).attr("item");
                            var quanlity = $('#quanlity').val();
                            var cartItem = $('#CartCount').text();
                            ...
                            getSoLuong().then(soluong => {
                                ...
                                if (soluong > 0) {
                                    ...
                                    if (quanlity === "" || quanlity <= 0) {
                                        SoLuongMua = 1;
                                        $('#CartCount').val(1);
                                    }

                                    else if (parseInt(quanlity) <= parseInt(soluong)) {
                                        SoLuongMua = quanlity;
                                        
                                    } else {
                                        SoLuongMua = soluong;
                                        $('#CartCount').val(soluong);
                                    ...
                                    $.ajax({
                                        async: true,
                                        type: 'POST',
                                        data: { MaSP: idItem, SoLuongMua: SoLuongMua },
                                        url: 'addtocart.php',
